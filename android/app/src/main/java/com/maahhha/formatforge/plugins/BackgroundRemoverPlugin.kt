...
import com.ghayas.auto_background_remover.PhotoEditor  // if this was the old import, remove it
...
class BackgroundRemoverPlugin : Plugin() {
    ...
    fun removeBackground(call: PluginCall) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                // This is the correct Kotlin extension function from the library
